...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_FRIEND, TRAINER_ENCOUNTER_MUSIC_MALE},
    {TRAINER_CLASS_FRIEND_IGNI, TRAINER_ENCOUNTER_MUSIC_IGNI},
    {TRAINER_CLASS_DEVELOPER, TRAINER_ENCOUNTER_MUSIC_DEVELOPER},
    {TRAINER_CLASS_RG_ROCKET, TRAINER_ENCOUNTER_MUSIC_RG_ROCKET},
    {TRAINER_CLASS_RG_PROFESSOR, TRAINER_ENCOUNTER_MUSIC_RG_PROFESSOR},
    {TRAINER_CLASS_GS_PROFESSOR, TRAINER_ENCOUNTER_MUSIC_GS_PROFESSOR},
    {TRAINER_CLASS_RSE_PROFESSOR, TRAINER_ENCOUNTER_MUSIC_RSE_PROFESSOR},
};
