const struct Trainer gTrainers[] = {
	...
	[TRAINER_SEAWOLF] =
    {
        .trainerClass = TRAINER_CLASS_FRIEND,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_MALE,
        .trainerPic = TRAINER_PIC_BUG_CATCHER,
        .trainerName = _("Seawolf"),
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_NONE},
        .doubleBattle = TRUE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SMART_SWITCHING | AI_FLAG_OMNISCIENT | AI_FLAG_SETUP_FIRST_TURN,
        .party = TRAINER_PARTY(sParty_Seawolf),
    },

    [TRAINER_IGNIRIS] =
    {
        .trainerClass = TRAINER_CLASS_FRIEND_IGNI,
        .encounterMusic_gender = F_TRAINER_FEMALE | TRAINER_ENCOUNTER_MUSIC_IGNI,
        .trainerPic = TRAINER_PIC_LASS,
        .trainerName = _("Igniris"),
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SMART_SWITCHING | AI_FLAG_OMNISCIENT | AI_FLAG_SETUP_FIRST_TURN,
        .party = TRAINER_PARTY(sParty_Igniris),
    },

    [TRAINER_DEVELOPER] =
    {
        .trainerClass = TRAINER_CLASS_DEVELOPER,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_DEVELOPER,
        .trainerPic = TRAINER_PIC_BUG_CATCHER,
        .trainerName = _("Skarlet"),
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SMART_SWITCHING | AI_FLAG_OMNISCIENT | AI_FLAG_SETUP_FIRST_TURN,
        .party = TRAINER_PARTY(sParty_Developer),
    },

    [TRAINER_PROF_OAK] =
    {
        .trainerClass = TRAINER_CLASS_RG_PROFESSOR,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_DEVELOPER,
        .trainerPic = TRAINER_PIC_BUG_CATCHER,
        .trainerName = _("Oak"),
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_NONE},
    ...
    [TRAINER_PROF_ELM] =
    {
        .trainerClass = TRAINER_CLASS_GS_PROFESSOR,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_DEVELOPER,
        .trainerPic = TRAINER_PIC_BUG_CATCHER,
        .trainerName = _("Elm"),
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_NONE},
    ...
    [TRAINER_PROF_BIRCH] =
    {
        .trainerClass = TRAINER_CLASS_RSE_PROFESSOR,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_DEVELOPER,
        .trainerPic = TRAINER_PIC_BUG_CATCHER,
        .trainerName = _("Birch"),
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_NONE},
