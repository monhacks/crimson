const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_FRIEND] = _("Friend"),
    [TRAINER_CLASS_FRIEND_IGNI] = _("Friend"),
    [TRAINER_CLASS_DEVELOPER] = _("Developer"),
    [TRAINER_CLASS_RG_ROCKET] = _("Team Rocket"),
    [TRAINER_CLASS_RG_PROFESSOR] = _("{PKMN} Prof."),
    [TRAINER_CLASS_GS_PROFESSOR] = _("{PKMN} Prof."),
    [TRAINER_CLASS_RSE_PROFESSOR] = _("{PKMN} Prof."),
};
