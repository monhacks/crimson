...
static const struct TrainerMon sParty_Seawolf[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    ...
    .moves = {MOVE_MIMIC, MOVE_PROTECT, MOVE_SHADOW_BALL, MOVE_SUCKER_PUNCH},
    ...
    .moves = {MOVE_ENTRAINMENT, MOVE_DAZZLING_GLEAM, MOVE_ICE_BEAM, MOVE_THUNDER_WAVE},
    .heldItem = ITEM_QUICK_CLAW
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .ev = TRAINER_PARTY_EVS(0, 176, 176, 156, 0, 0),
    .nature = NATURE_BASHFUL,
    .ability = ABILITY_INTIMIDATE,
    .lvl = 100,
    .species = SPECIES_ARCANINE,
    .moves = {MOVE_BURN_UP, MOVE_EXTREME_SPEED, MOVE_FIRE_BLAST, MOVE_FIRE_FANG},
    ...
    .moves = {MOVE_DRAGON_ASCENT, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE, MOVE_EXTREME_SPEED},
    ...
    .lvl = 100,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_FLING, MOVE_EXTREME_SPEED, MOVE_DIG, MOVE_TOXIC},
    ...
    .moves = {MOVE_FLING, MOVE_DUAL_CHOP, MOVE_DOUBLE_SLAP, MOVE_DOUBLE_TEAM},
    .heldItem = ITEM_RAZOR_FANG
    }
};

static const struct TrainerMon sParty_Igniris[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_SLUDGE_WAVE, MOVE_FOCUS_BLAST, MOVE_SUBSTITUTE},
    ...
    .moves = {MOVE_SPORE, MOVE_STEALTH_ROCK, MOVE_STICKY_WEB, MOVE_BATON_PASS},
    .heldItem = ITEM_FOCUS_SASH
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    ...
    .lvl = 100,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_MOONBLAST, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_FOCUS_BLAST},
    ...
    .moves = {MOVE_KNOCK_OFF, MOVE_ENCORE, MOVE_TAUNT, MOVE_PLAY_ROUGH},
    .heldItem = ITEM_BLACK_GLASSES
    }
};

static const struct TrainerMon sParty_Developer[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .nature = NATURE_JOLLY,
    ...
    .lvl = 100,
    .species = SPECIES_PIKACHU,
    .moves = {MOVE_VOLT_TACKLE, MOVE_THUNDERBOLT, MOVE_QUICK_ATTACK, MOVE_IRON_TAIL},
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_CLAW, MOVE_FLARE_BLITZ, MOVE_ROOST},
    ...
    .moves = {MOVE_FUSION_FLARE, MOVE_BLUE_FLARE, MOVE_DRACO_METEOR, MOVE_DRAGON_PULSE},
    .heldItem = ITEM_LEFTOVERS
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    ...
    .lvl = 100,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_PSYSHOCK, MOVE_MOONBLAST, MOVE_SHADOW_BALL, MOVE_CALM_MIND},
    ...
    .moves = {MOVE_CLOSE_COMBAT, MOVE_AURA_SPHERE, MOVE_EXTREME_SPEED, MOVE_SWORDS_DANCE},
    .heldItem = ITEM_LIFE_ORB
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_DRAGON_PULSE, MOVE_SIGNAL_BEAM, MOVE_COTTON_GUARD},
    .heldItem = ITEM_LEFTOVERS
    }
};

static const struct TrainerMon sParty_Prof_Oak[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    .nature = NATURE_JOLLY,
