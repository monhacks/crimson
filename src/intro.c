...
static void Task_Scene3_Groudon(u8 taskId)
{
    ...
    case 5:
        if (--tDelay == 0)
        {
            ...
            tScreenY = 41;
            tDelay = 16;
            PlayCryInternal(SPECIES_GROUDON_PRIMAL, 0, 100, CRY_PRIORITY_NORMAL, CRY_MODE_NORMAL);
            tState++;
        }
        break;
    case 6:
    ...
    case 5:
        if (--tDelay == 0)
        {
            ...
            else
            {
                tDelay = 1;
                tState++;
                PlayCryInternal(SPECIES_KYOGRE_PRIMAL, 0, 120, CRY_PRIORITY_NORMAL, CRY_MODE_NORMAL);
            }
        }
        break;
    case 6:
...
static void Task_RayquazaAttack(u8 taskId)
{
    ...
    case 1:
        if (data[3] == 0)
        {
            ...
            if (data[1] == 6)
            {
                PlayCryInternal(SPECIES_RAYQUAZA, 0, 120, CRY_PRIORITY_NORMAL, CRY_MODE_NORMAL);
                tState++;
                data[3] = 10;
            }
        }
