...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    case SPECIES_MEW:
        ...
        break;
    case SPECIES_RAIKOU:
        CreateBattleStartTask(B_TRANSITION_WAVE, MUS_HG_VS_RAIKOU);
        break;
    case SPECIES_ENTEI:
        CreateBattleStartTask(B_TRANSITION_WAVE, MUS_HG_VS_ENTEI);
        break;
    case SPECIES_SUICUNE:
        CreateBattleStartTask(B_TRANSITION_WAVE, MUS_HG_VS_SUICUNE);
        break;
    case SPECIES_LUGIA:
        CreateBattleStartTask(B_TRANSITION_WAVE, MUS_HG_VS_LUGIA);
        break;
    case SPECIES_HO_OH:
        CreateBattleStartTask(B_TRANSITION_WHITE_BARS_FADE, MUS_HG_VS_HO_OH);
        break;
    case SPECIES_CELEBI:
        CreateBattleStartTask(B_TRANSITION_WHITE_BARS_FADE, MUS_HG_VS_WILD);
        break;
    ...
    case SPECIES_DIALGA:
    case SPECIES_PALKIA:
        CreateBattleStartTask(B_TRANSITION_SWIRL, MUS_DP_VS_DIALGA_PALKIA);
        break;
    case SPECIES_UXIE:
    case SPECIES_MESPRIT:
    case SPECIES_AZELF:
        CreateBattleStartTask(B_TRANSITION_CLOCKWISE_WIPE, MUS_DP_VS_UXIE_MESPRIT_AZELF);
        break;
    case SPECIES_CRESSELIA:
    case SPECIES_DARKRAI:
    case SPECIES_HEATRAN:
    case SPECIES_REGIGIGAS:
        CreateBattleStartTask(B_TRANSITION_SHUFFLE, MUS_DP_VS_LEGEND);
        break;
    case SPECIES_GIRATINA:
        CreateBattleStartTask(B_TRANSITION_BLACKHOLE_PULSATE, MUS_PL_VS_GIRATINA);
        break;
    case SPECIES_ARCEUS:
        CreateBattleStartTask(B_TRANSITION_SLICE, MUS_DP_VS_ARCEUS);
        break;
    case SPECIES_ZEKROM:
    case SPECIES_RESHIRAM:
        CreateBattleStartTask(B_TRANSITION_WHITE_BARS_FADE, MUS_BW_VS_RESHIRAM_ZEKROM);
        break;
    }
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (trainerClass == TRAINER_CLASS_FRIEND)
        return B_TRANSITION_BIG_POKEBALL;

    if (trainerClass == TRAINER_CLASS_FRIEND_IGNI)
        return B_TRANSITION_BLACKHOLE_PULSATE;

    if (trainerClass == TRAINER_CLASS_DEVELOPER)
        return B_TRANSITION_MUGSHOT;
...
void PlayTrainerEncounterMusic(void)
{
        ...
        && sTrainerBattleMode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        case TRAINER_ENCOUNTER_MUSIC_RICH:
            ...
            break;
        case TRAINER_ENCOUNTER_MUSIC_IGNI:
            music = MUS_RG_ENCOUNTER_GYM_LEADER;
            break;
        case TRAINER_ENCOUNTER_MUSIC_DEVELOPER:
            music = MUS_RG_ENCOUNTER_RIVAL;
            break;
        case TRAINER_ENCOUNTER_MUSIC_RG_ROCKET:
            music = MUS_HG_ENCOUNTER_ROCKET;
            break;
        case TRAINER_ENCOUNTER_MUSIC_RG_PROFESSOR:
            music = MUS_RG_ENCOUNTER_GYM_LEADER;
            break;
        case TRAINER_ENCOUNTER_MUSIC_GS_PROFESSOR:
            music = MUS_RG_ENCOUNTER_GYM_LEADER;
            break;
        case TRAINER_ENCOUNTER_MUSIC_RSE_PROFESSOR:
