...
u16 GetBattleBGM(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
        ...
        case TRAINER_CLASS_FRIEND:
            return MUS_PL_VS_GIRATINA;
        case TRAINER_CLASS_FRIEND_IGNI:
            return MUS_DP_VS_ARCEUS;
        case TRAINER_CLASS_DEVELOPER:
            return MUS_PL_VS_FRONTIER_BRAIN;
        case TRAINER_CLASS_RG_ROCKET:
            return MUS_HG_VS_ROCKET;
        case TRAINER_CLASS_RG_PROFESSOR:
            return MUS_RG_VS_GYM_LEADER;
        case TRAINER_CLASS_GS_PROFESSOR:
            return MUS_HG_VS_GYM_LEADER;
        case TRAINER_CLASS_RSE_PROFESSOR:
            return MUS_VS_GYM_LEADER;
        default:
            return MUS_VS_TRAINER;
        }
